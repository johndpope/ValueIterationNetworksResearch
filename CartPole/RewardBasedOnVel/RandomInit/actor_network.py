...
tf.app.flags.DEFINE_integer('width', 7, 'Size of conv filter (~state connectivity)')
tf.app.flags.DEFINE_integer('ch_i', 1, 'Channels in input layer')
tf.app.flags.DEFINE_integer('ch_q', 50, 'Channels in q layer (~actions)')
tf.app.flags.DEFINE_integer('vel_hidden1', 50, "Size of first hidden layer for velocity")
tf.app.flags.DEFINE_integer('hidden1', 50, 'Size of first hidden layer')
tf.app.flags.DEFINE_integer('hidden2', 50, 'Size of second hidden layer')
