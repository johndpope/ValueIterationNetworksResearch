...
class CriticNetwork:
	...
	def create_q_network(self,state_dim,action_dim):
		...
		b4 = self.variable([layer4_size], layer3_size)
		...
		return state_input,action_input,q_value_output,[W1,b1,W2,W2_action,b2,W3,b3,W4,b4,W5,b5]
	...
	def create_target_q_network(self,state_dim,action_dim,net):
		...
		layer4 = tf.nn.relu(tf.matmul(layer3,target_net[7]) + target_net[8])
		q_value_output = tf.identity(tf.matmul(layer4,target_net[9]) + target_net[10])
