...
#Batch size for reward maps (always 1)
tf.app.flags.DEFINE_integer('batchsize', 1, 'Batch Size')

#NOTE if changing conv type in VIN change in print out below
...
class ActorNetwork:
    ...
    def create_training_method(self):
        ...
        self.optimizer = tf.train.AdamOptimizer(LEARNING_RATE, .99, .9999).apply_gradients(zip(self.parameters_gradients,self.net))
