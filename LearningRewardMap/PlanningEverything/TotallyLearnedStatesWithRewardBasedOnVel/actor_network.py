...
tf.app.flags.DEFINE_integer('vel_hidden1', 100, "Size of first hidden layer for velocity")
tf.app.flags.DEFINE_integer('state_hidden1', 100, "Size of first hidden layer for velocity")
tf.app.flags.DEFINE_integer('hidden1', 30, 'Size of first hidden layer')
tf.app.flags.DEFINE_integer('hidden2', 30, 'Size of second hidden layer')
